...
if __name__ == "__main__":
    # 生成5x5栅格MDP
    robot_nodes_w_aps, robot_edges, U, node_positions = construct_team_mdp()
    ...
    for node, attrs in robot_nodes_w_aps.items():
        G.add_node(node, pos=node_positions[node]["pos"])  # 直接从grid_nodes获取位置
    ...
    plt.title("5x5 Grid MDP Visualization")
    plt.tight_layout()
    plt.show()